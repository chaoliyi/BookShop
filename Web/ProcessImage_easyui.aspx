<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessImage_easyui.aspx.cs" Inherits="BookShop.Web.ProcessImage_easyui" %>
    ...
    <form id="form1" runat="server">
        <div id="content">
            <div id="swfu_container" style="margin: 0px 10px;">
                ...
                <!--style中的position和overflow必须-->
                <div id="divShowImage" style="position:relative;overflow:hidden;width:300px;height:300px;">
